<!-- GENERATED FILE, do not edit. Vendored by scripts/sync.mjs from agentskills/agentskills docs/skill-creation/using-scripts.mdx. -->

# Using scripts in skills

> How to run commands and bundle executable scripts in your skills.

_Source: <https://github.com/agentskills/agentskills/blob/main/docs/skill-creation/using-scripts.mdx>_
